...
export const LogbookView: React.FC = () => {
    ...
    const isManager = activeRole?.name === 'Encargado';
        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-1">
                    <Card title={editingEntry ? 'Editar Entrada de Bitácora' : 'Nueva Entrada en Bitácora'}>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                ...
                                <Button type="submit">{editingEntry ? 'Actualizar Nota' : 'Guardar Nota'}</Button>
                            </div>
                        </form>
                    </Card>
                </div>
