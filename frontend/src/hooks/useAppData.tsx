...
export const AppDataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    addAssignment,
    updateAssignmentStatus: (id, status) => updateAssignment(id, { status }),
    reassignTask: (id, employeeIds) => updateAssignment(id, { employeeIds }),
    completeAssignment: (id, completedTasks, observations) => updateAssignment(id, { status: AssignmentStatus.COMPLETADA, completedTasks, observations }),
    addCheckIn: checkInsHandler.add,
    updateCheckIn: checkInsHandler.update,
    deleteCheckIn: checkInsHandler.remove,
    addWorkOrder,
    updateWorkOrderWorkDone: (id, completionDate, materialsUsed) => updateWorkOrder(id, { status: WorkOrderStatus.REALIZADO, completionDate, materialsUsed }),
    updateWorkOrderApproval: (id, approvalName, approvalDate) => updateWorkOrder(id, { status: WorkOrderStatus.CONFORME, approvalName, approvalDate }),
